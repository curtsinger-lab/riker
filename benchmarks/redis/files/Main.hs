...
main = rattleRun rattleOptions $ do
  ...
  cmd "install  redis-server  redis-sentinel"
  cmd "install  redis-server  redis-check-aof"
  cmd "install  redis-server  redis-check-rdb"
