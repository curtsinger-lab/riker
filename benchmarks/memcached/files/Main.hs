...
main = rattleRun rattleOptions $ do
  ...
  cmd Shell "gcc  -DHAVE_CONFIG_H -I. -g -O2 -pthread -pthread -Wall -Werror -pedantic -Wmissing-prototypes -Wmissing-declarations -Wredundant-decls  -o  sizes  sizes.c  -levent"
  cmd Shell "gcc  -DHAVE_CONFIG_H -I. -g -O2 -pthread -pthread -Wall -Werror -pedantic -Wmissing-prototypes -Wmissing-declarations -Wredundant-decls  -o  testapp  testapp.c util.c stats_prefix.c jenkins_hash.c murmur3_hash.c cache.c crc32c.c  -levent"
  cmd Shell "gcc  -DHAVE_CONFIG_H -I. -g -O2 -pthread -pthread -Wall -Werror -pedantic -Wmissing-prototypes -Wmissing-declarations -Wredundant-decls  -o  timedrun  timedrun.c  -levent"
