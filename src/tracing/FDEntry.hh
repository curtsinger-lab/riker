...
class FDEntry {
 public:
  ...
  FDEntry(shared_ptr<Reference> ref, Artifact artifact, bool writable, bool cloexec = false) :
  ...
  const Artifact& getArtifact() const { return _artifact; }
 ...
 private:
  ...
  Artifact _artifact;          //< The artifact referred to via this file descriptor
