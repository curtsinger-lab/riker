...
class TraceHandler {
 public:
  ...
  virtual void usingRef(const shared_ptr<Command>& command, Command::RefID ref) noexcept {}

  /// Handle a DoneWithRef IR step
  virtual void doneWithRef(const shared_ptr<Command>& command, Command::RefID ref) noexcept {}
